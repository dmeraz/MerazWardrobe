...
namespace MerazWardrobe.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Name,Photo,Style,Color,Season,Occasion")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Name,Photo,Style,Color,Season,Occasion")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
