...
namespace MerazWardrobe.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesID,Name,Photo,Style,Color,Season,Occasion")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesID,Name,Photo,Style,Color,Season,Occasion")] Sho sho)
        {
            if (ModelState.IsValid)
            {
